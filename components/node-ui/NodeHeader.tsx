        ...
        {isRerouteDot ? (
            ...
            <>
                ...
                >
                  ...
                  {!isNoteMinimal && node.type !== NodeType.IMAGE_EDITOR && node.type !== NodeType.GEMINI_CHAT && node.type !== NodeType.CHARACTER_CARD && (<ActionButton title={t('node.action.copy')} onClick={() => onCopyNodeValue(node.id)}>
                      <CopyIcon className="h-4 w-4" />
                  </ActionButton>)}
