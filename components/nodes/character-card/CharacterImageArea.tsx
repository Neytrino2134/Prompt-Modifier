...
export const CharacterImageArea: React.FC<CharacterImageAreaProps> = ({
    ...
    onRatioChange, onPasteImage, onClearImage, onCopyImage, onDownloadImage, onGenerateImage,
                ...
                {char.thumbnails[char.selectedRatio] || char.image ? (
                    <>
                        ...
                        <div className="absolute top-2 right-2 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity z-20">
                            <ActionButton title={t('node.action.download')} onClick={(e) => { e.stopPropagation(); onDownloadImage(); }} className="bg-black/60 p-1.5 rounded text-accent-text hover:text-white" tooltipPosition="left">
