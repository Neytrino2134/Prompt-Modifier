...
import { StarIcon, StarFilledIcon, PromptIcon, CopyIcon, DetachIcon } from '../../../components/icons/AppIcons';
...
const CharacterCardItem: React.FC<CharacterCardItemProps> = ({
    ...
    onUpdate, onRemove, onSetAsOutput, onDragStart, onDragEnd, onSmartDragOver,
    ...
    return (
        <div 
            ...
            onDragOver={onSmartDragOver} // Add smart drag listener to main container
        >
            {/* Header - DRAGGABLE */}
            <div 
            ...
            <div className="flex gap-2 flex-shrink-0 items-center mb-2 h-[32px]">
                ...
                <InputWithSpinners 
                    ...
                    placeholder="Index" 
                    onFocus={deselectAllNodes}
                    readOnly={true} // Strict requirement: Read Only text input
            ...
            {/* Additional Prompt Input with Toggle Arrows */}
            <div className="flex flex-col gap-1 mb-2 shrink-0">
            ...
            >
                ...
                {!char.isDescriptionCollapsed && (
                    <div 
                        className="overflow-y-auto custom-scrollbar flex-grow overflow-x-hidden mr-1" // Added mr-1 to move scrollbar left from edge
