                     ...
                     <div className="flex items-center space-x-1">
                         <ActionButton 
                            ...
                            className={`p-1 rounded transition-colors ${
                                isInputConnected 
                                    ? 'text-cyan-400 hover:text-cyan-200 hover:bg-gray-600' 
                         ...
                         <ActionButton title={t('node.action.refresh') || "Обновить данные"} onClick={(e) => { e.stopPropagation(); handleManualRefresh(); }}>
