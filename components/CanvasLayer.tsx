...
const CanvasLayer: React.FC = () => {
    ...
    const {
        ...
        onRefreshChat, handleRefreshImageEditor, handleAutoDownloadChange, handleModelChange, handleCustomPromptChange, handleResolutionChange, handleAspectRatioChange,
